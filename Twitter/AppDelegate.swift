...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        var tvc: TweetsViewController
        var pvc: ProfileViewController
        var mvc: MentionsViewController
        var lvc: LoginViewController
        var cvc: TweetComposeViewController
    
        tvc = self.storyboard.instantiateViewControllerWithIdentifier("TweetsViewController") as TweetsViewController
        ...
        lvc = self.storyboard.instantiateViewControllerWithIdentifier("LoginViewController") as LoginViewController
        cvc = self.storyboard.instantiateViewControllerWithIdentifier("TweetComposeViewController") as TweetComposeViewController
        
        let menuViewController = window!.rootViewController! as MenuViewController
        
        menuViewController.viewControllers = [tvc, mvc, pvc]
        menuViewController.cvc = cvc
    ...
    func userDidLogout() {
        ...
        let menuViewController = window!.rootViewController! as MenuViewController
        menuViewController.activeViewController = lvc
